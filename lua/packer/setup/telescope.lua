...
vim.api.nvim_set_keymap('n', '<leader>uu', ':Telescope find_files<cr>', settings)
...
vim.api.nvim_set_keymap('n', '<leader>uo', ':Telescope lsp_document_symbols<cr>', settings)
vim.api.nvim_set_keymap('n', '<localleader>uo', ':Telescope lsp_workspace_symbols<cr>', settings)

vim.api.nvim_set_keymap('n', 'ge', ':Telescope lsp_document_diagnostics<cr>', settings)
vim.api.nvim_set_keymap('n', 'gE', ':Telescope lsp_workspace_diagnostics<cr>', settings)
vim.api.nvim_set_keymap('n', 'gd', ':Telescope lsp_definitions<cr>', settings)
vim.api.nvim_set_keymap('n', 'gi', ':Telescope lsp_implementations<cr>', settings)
